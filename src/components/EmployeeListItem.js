...
const EmployeeListItem = (props) => {
  return <div>
      ...
      <div className='list-action' onClick={(e) => props.editEmployee('View', props.index)}>View</div>
      <div className='list-action' onClick={(e) => props.editEmployee('Edit', props.index)}>Edit</div>
